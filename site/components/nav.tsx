  ...
  return (
    <header className="sticky top-0 z-40 border-b border-edge bg-bg/85 backdrop-blur-md">
      <div className="mx-auto flex h-13 max-w-6xl items-center gap-7 px-4 sm:px-6">
        ...
        <a
          href={SITE.coreRepo}
          className="ml-auto inline-flex items-center gap-2 rounded-full border border-edge px-3 py-1.5 text-[13px] text-mute transition-colors hover:border-edge-strong hover:text-ink"
        >
